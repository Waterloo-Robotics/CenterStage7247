...
public class RedTeamPropPipeline extends OpenCvPipeline {
    ...
    public static PropPosition propPosition = PropPosition.Middle;
...
//    public static Scalar scalarUpperYCrCb = new Scalar(210, 61, 203);
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 180.0, 30.0);
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 230.0, 110.0);
